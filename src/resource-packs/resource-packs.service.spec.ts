...
import { ResourcePack, ResourcePackSchema } from './schemas/resource-pack.schema';

const resource_packs = data2list(data.resource_packs);

const create_resource_packs = data2list(data.create_resource_packs);
const files = [data.create_files.resources_pack_1, data.create_files.resources_pack_2];
...
describe('ResourcePacksService', () => {
    ...
    beforeAll(async () => {
        module = await Test.createTestingModule({
            ...
            providers: [ResourcePacksService, ResourcesService, FilesService, UsersService],
        }).compile();

        resourcePacksService = module.get<ResourcePacksService>(ResourcePacksService);
    ...
    describe('When find one resource pack by title', () => {
        it('should return one resource pack', async () => {
            ...
            const result = await resourcePacksService
                .findResourcePackByTitle(data.resource_packs.resource_pack1.title);
    ...
    describe('When find one resource pack by id', () => {
        it('should return one resource pack', async () => {
            ...
            const result = await resourcePacksService.findResourcePackById(resourcePackId);
    ...
    describe('When remove one resource pack', () => {
        it('should return one resource pack infos', async () => {
            ...
            const result = await resourcePacksService.removeResourcePack(resourcePackId);
