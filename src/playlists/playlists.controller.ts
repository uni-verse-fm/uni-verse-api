...
export class PlaylistsController {
    ...
    create(
        ...
        return this.playlistsService.createPlaylist(createPlaylistDto, request.user);
    }
    ...
    update(
        ...
        return this.playlistsService.updatePlaylist(id, updatePlaylistDto, request.user);
    }
